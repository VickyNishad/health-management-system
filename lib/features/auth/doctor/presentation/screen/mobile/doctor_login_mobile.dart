...
class DoctorLoginMobile extends StatefulWidget {
  const DoctorLoginMobile({super.key});

  @override
  State<DoctorLoginMobile> createState() => _DoctorLoginMobileState();
}

class _DoctorLoginMobileState extends State<DoctorLoginMobile> {
