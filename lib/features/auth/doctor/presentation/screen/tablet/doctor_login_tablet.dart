...
class DoctorLoginTablet extends StatefulWidget {
  const DoctorLoginTablet({super.key});

  @override
  State<DoctorLoginTablet> createState() => _DoctorLoginTabletState();
}

class _DoctorLoginTabletState extends State<DoctorLoginTablet> {
