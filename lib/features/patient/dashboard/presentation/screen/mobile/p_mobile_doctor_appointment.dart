...
class PMobileDoctorAppointment extends StatefulWidget {
  const PMobileDoctorAppointment({super.key});

  @override
  State<PMobileDoctorAppointment> createState() =>
      _PMobileDoctorAppointmentState();
}

class _PMobileDoctorAppointmentState extends State<PMobileDoctorAppointment> {
  @override
